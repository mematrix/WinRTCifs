...
using Thread = WinrtCifs.Util.Sharpen.Thread;
        ...
        public virtual void Run()
        {
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    //NEW SOCKET
                    int len = _socket.Receive(_rcvBuf, 0, RcvBufSize, System.Net.Sockets.SocketFlags.None);
                ...
                while (max-- > 0)
                {
                    try
                    {
                        lock (_lock)
                        {
                            ...
                            //NEW SOCKET
                            _socket.Send(_sndBuf, 0, requestLenght, SocketFlags.None);
