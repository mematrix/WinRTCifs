...
namespace WinrtCifs.Smb
{
	...
	public class Sid : Rpc.SidT
	{
		...
		internal static Util.Sharpen.Hashtable SidCache = new Util.Sharpen.Hashtable();
		...
		{
			return new Sid(this, SidTypeDomain, DomainName, null, GetSidType() 
				!= SidTypeDomain);
		}

		public virtual int GetRid()
		{
			if (GetSidType() == SidTypeDomain)
			{
